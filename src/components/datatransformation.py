...
class DataTransformation:
    ...
    def get_data_transformation(self):
        ...
        try:
            ...
            ordinal_encode_cols = [
                'Total_Stops', 'Journey_Weekday', 'Departure_Part_of_Day', 'Arrival_Part_of_Day']
            numerical_cols = ['Duration_Hour',
    ...
    def initialize_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            for df in [train_df, test_df]:
                ...
                df['Journey_Weekday'] = pd.to_datetime(
                    df['Date_of_Journey'], format='%d/%m/%Y').dt.day_name()

            preprocessing_obj = self.get_data_transformation()

            target_column_name = 'Price'
            drop_columns = [target_column_name, 'Date_of_Journey', 'Route',
